...
public class Enemy_c : MonoBehaviour
{
    ...
    uOscClient client_phone;
    uOscClient client_this;

    public GameObject Client_phone;
    public GameObject Client_this;
    ...
    public void meta(){
        ...
        var client_phone = Client_phone.GetComponent<uOscClient>();
        client_phone.Send("/damage");
        GameObject.Find("Manager").GetComponent<Controller_Brain>().Confuse();
        Debug.Log("Send");
        Destroy( gameObject );
    }
